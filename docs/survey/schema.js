...
//      Q2 가 분기 게이트다. LLM 을 쓰는 사람은 11문항, 안 쓰는 사람은 8문항을 받는다.

export const VERSION = 2;

export const SECTIONS = {
  A: { label: '배경', note: '응답자 · 사용 여부' },
  B: { label: 'LLM 사용 실태', note: '무엇이 어긋나는가' },
  C: { label: '현행 부담', note: '어디에 시간이 드는가' },
  D: { label: '작업 환경', note: '배포 경로 판단' },
  E: { label: '수요', note: '' },
};

// LLM 을 쓰거나 써본 사람에게만 여는 상세 문항의 조건.
const USED_LLM = { q2: [1, 2, 3, 4] };
...
export const QUESTIONS = [
  ...
  },
  {
    ...
    hint: '이 답에 따라 이후 문항이 달라집니다. 쓰지 않으신다고 해서 불이익이 되는 조사가 아닙니다.',
    options: [
      '거의 매번 쓴다',
      '자주 쓴다',
      '가끔 쓴다',
  ...
  /* ── B. LLM 사용 실태 ────────────────────────────── */
  {
    id: 'q3', section: 'B', type: 'multi', min: 1, showIf: USED_LLM,
    text: '보고서 작업의 어느 단계에 쓰십니까(쓰셨습니까)?',
    options: [
      '자료 조사 · 사실 확인',
      '목차 · 개요 잡기',
      '초안 문장 작성',
  ...
  {
    id: 'q4', section: 'B', type: 'single', showIf: USED_LLM,
  ...
  {
    id: 'q5', section: 'B', type: 'multi', min: 1, showIf: USED_LLM,
    text: 'LLM 결과에서 겪은 문제를 모두 골라 주십시오.',
    options: [
      '없는 수치 · 사실을 지어냈다 — 그럴듯한 통계값이 출처 없이 나오는 식',
      '출처를 물으면 대지 못하거나 엉뚱한 것을 댔다',
      '우리 기관을 다른 기관으로 잘못 알았다 — “KCA” 를 한국소비자원으로 안내하는 식',
      '개조식(□ · ㅇ · -) 이나 기관 문투에 맞지 않는 문장이 나왔다',
      '읽는 사람이 “AI 로 쓴 티”를 알아챌 문체였다',
      '표 · 수치 정리가 어긋났다',
      '같은 배경 설명 · 참고자료를 매번 다시 넣어야 했다',
      '보안 · 망분리 때문에 필요한 내부 자료를 넣지 못했다',
    ],
    noneOption: '별다른 문제는 없었다',
  },
  {
    id: 'q6', section: 'B', type: 'single', showIf: USED_LLM,
    text: 'LLM 이 써 준 문장 속 수치 · 인용의 근거를 어떻게 확인하십니까?',
    options: [
      '모든 수치 · 인용을 원문에서 직접 다시 확인한다',
      '중요해 보이는 것만 골라 확인한다',
      '따로 확인하지 않고 쓴다',
      '애초에 수치 · 인용은 LLM 에 맡기지 않는다',
    ],
  },
  {
    id: 'q2n', section: 'B', type: 'single', showIf: { q2: [4, 5] },
    text: '쓰지 않으시는(그만두신) 가장 큰 이유는 무엇입니까?',
    options: [
      '보안 · 규정 위반이 걱정된다',
  ...
  },
  {
    ...
    text: '보고서 한 건에서 가장 많은 시간을 잡아먹는 작업 하나만 고른다면?',
