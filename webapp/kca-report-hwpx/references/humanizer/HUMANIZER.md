...
> 출처: DaleSeo — https://github.com/DaleSeo · MIT License (같은 폴더 `LICENSE`)
> kca-report-hwpx 번들 사본. 원본 `SKILL.md`에서 **프론트매터만 제거**하고 파일명을
> `HUMANIZER.md`로 바꿨다(패키지 루트 매니페스트와 혼동 방지). 본문은 무수정이다.
